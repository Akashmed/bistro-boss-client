...
const Order = () => {
    ...
    return (
        <div>
            ...
            {value === "one" && <FoodTab items="salad"></FoodTab>}
            {value === "two" && <FoodTab items="pizza"></FoodTab>}
            {value === "three" && <FoodTab items="soup"></FoodTab>}
            {value === "four" && <FoodTab items="dessert"></FoodTab>}
